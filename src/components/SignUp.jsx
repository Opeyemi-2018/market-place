      ...
      <div className='md:max-w-[500px] max-w-[300px] mx-auto '>
        <div className=''>
          ...
          <form className='flex flex-col  mt-4'>
            <input className='border outline-none border-gray-300 mb-4 md:p-[8px]  p-[7px] rounded-md shadow-md placeholder-gray-400 text-[14px]' type="text" placeholder='Enter email address' />
            <input className='border outline-none border-gray-300 mb-6 md:p-[8px] p-[7px] rounded-md mt shadow-md  placeholder-gray-400 text-[14px]' type="text" placeholder='Create a password' />
